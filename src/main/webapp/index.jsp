...
<%
	String xdirequest = WebshopConnectionRequest.requestAddressConnectionRequest(request.getServletContext()).getMessageEnvelope().getGraph().toString("XDI/JSON", null);
%>

<img src="images/trip.jpg"><br><br>

<p>We need your name and address for your ticket. Please connect to your Personal Cloud.</p>
